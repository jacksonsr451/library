...
export class default1669574315312 implements MigrationInterface {
    name = 'default1669574315312'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "books" ("isbn" varchar PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "author" varchar NOT NULL, "coAuthro" text NOT NULL, "description" text NOT NULL)`);
